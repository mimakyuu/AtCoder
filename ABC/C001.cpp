...
signed main() {
    ...
    int dis;
    cin >> dis;
    auto deg2news = [](int ang){
        int id = (ang*10-1125) / 2250;
        vector<string> news{"NNE", "NE", "ENE", "E", "ESE", "SE", "SSE", "S", "SSW", "SW", "WSW", "W", "WNW", "NW", "NNW", "N"};
        return news[id];
    };
    
    auto wind2id = [](int wind){
        wind *= 100;
        wind /= 60;
        if(wind <= 24) return 0;
        else if(wind <=154) return 1;
        else if(wind <= 334) return 2;
        else if(wind <= 544) return 3;
        else if(wind <= 794) return 4;
        else if(wind <= 1074) return 5;
        else if(wind <= 1384) return 6;
        else if(wind <= 1714) return 7;
        else if(wind <= 2074) return 8;
        else if(wind <= 2444) return 9;
        else if(wind <= 2844) return 10;
        else if(wind <= 3264) return 11;
        else return 12;
    };
	
    if(wind2id(dis) == 0) cout << "C " << wind2id(dis) << endl; 
    else cout << dir << " " << wind2id(dis) << endl;
