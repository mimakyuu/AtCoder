...
signed main() {
	...
	rep(i, m) {
		rep(j, n) {
			j++;
			if (a[pa[j].second][i] == 'G' && a[pa[j-1].second][i] == 'C') pa[j].first++;
			if (a[pa[j].second][i] == 'C' && a[pa[j-1].second][i] == 'G') pa[j-1].first++;
			if (a[pa[j].second][i] == 'C' && a[pa[j-1].second][i] == 'P') pa[j].first++;
			if (a[pa[j].second][i] == 'P' && a[pa[j-1].second][i] == 'C') pa[j-1].first++;
			if (a[pa[j].second][i] == 'P' && a[pa[j-1].second][i] == 'G') pa[j].first++;
			if (a[pa[j].second][i] == 'G' && a[pa[j-1].second][i] == 'P') pa[j-1].first++;
		}
		
		sort(all(pa), [](auto x, auto y) {
